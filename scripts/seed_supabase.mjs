...
import { MASSAGE_SERVICES } from '../src/data/services.js';
import { INITIAL_THERAPISTS, INITIAL_USER, INITIAL_BOOKINGS } from '../src/data/mockData.js';
...
async function seedDatabase() {
  ...
  if (testErr && testErr.code === 'PGRST205') {
    ...
    console.log('Please execute the SQL in "supabase/schema.sql" in your Supabase project SQL Editor:');
